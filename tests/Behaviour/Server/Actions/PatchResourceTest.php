...
namespace NilPortugues\Tests\Api\JsonApi\Behaviour\Server\Actions;
...
use NilPortugues\Tests\Api\JsonApi\Behaviour\Dummy\ComplexObject\User;
use NilPortugues\Tests\Api\JsonApi\Behaviour\Dummy\ComplexObject\ValueObject\PostId;
...
class PatchResourceTest extends \PHPUnit_Framework_TestCase
{
    /**
    ...
    public function testItCanGetWillReturnUnprocessableEntityErrorResponse()
    {
        $data = [
            ...
            'id' => 10,
            'attributes' => [
                'this_field_does_not_exist' => 'My first blog post',
            ],
        ];
